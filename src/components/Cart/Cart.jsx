...
const Cart = () => {
    ...
    return cart.length > 0 ? (
        <div className="d-flex flex-column align-items-center">
            ...
            <p className="PrecioTotal text-white">
                Precio Total:
                <span className="precioTotalNumero">${totalPrice}</span>
            </p>
                    ...
                    <div key={objeto.id} className="cartContainer borderx">
                        <div className="card shadow-sm borderx">
                            ...
                            <div className="card-body">
                                <div className="clearfix mb-3 d-flex flex-column align-items-center">
                                ...
                                <p className="card-titlex">
                                    {objeto.descripcion}
                                </p>
                                <h5>Cantidad:{objeto.cantidad} </h5>
                                <h5>
                                    Precio: $
                                    {parseInt(objeto.cantidad * objeto.precio)}
                                </h5>
                                <div className="text-center my-4">
                                    <button
                                        className="btn boton-eliminar"
                                        onClick={() => {
                                            removeFromCart(objeto);
                                        }}
                                    >
        ...
        <div className="d-flex flex-column align-items-center pt-5">
            <h1 className="text-center text-white">No hay productos en el carrito</h1>
            <Link className="text-decoration-none comprar" to="/">
                <h2 className='vamosAComprar'>Click y vamos a comprar!</h2>
            </Link>
